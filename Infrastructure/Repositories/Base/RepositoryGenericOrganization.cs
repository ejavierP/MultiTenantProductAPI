...
{
    public class RepositoryGenericOrganization<TEntity> : IRepositoryOrganizations<TEntity> where TEntity : class , new()
    {
        protected readonly DbContext _dbContext;
        private readonly DbSet<TEntity> _dbSet;
        public RepositoryGenericOrganization(OrganizationsContext dbContext)
        {
